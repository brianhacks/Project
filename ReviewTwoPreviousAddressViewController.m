...
@interface ReviewTwoPreviousAddressViewController ()
@property (nonatomic, strong) FinalAcceptViewController * finalAcceptViewController;
@end

@implementation ReviewTwoPreviousAddressViewController
...
- (void)changeFormalAddressHeaderHeightAndAddInfo
{
    ...
    self.formalHomeAddressView.backgroundColor = [UIColor whiteColor];
